...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/bootstrap.bundle-5.0.0.alpha-min.js":[function(require,module,exports) {
var define;
...
!function (t, e) {
    ...
    if ("string" == typeof e && t) {
      ...
      if (f) f.oneOff = f.oneOff && o;else {
        var h = B(a, e.replace(x, "")),
          d = s ? function (t, e, n) {
            return function i(o) {
              for (var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode) for (var a = r.length; a--;) if (r[a] === s) return i.oneOff && V.off(t, o.type, n), n.apply(s, [o]);
              return null;
            };
          }(t, n, i) : function (t, e) {
            return function n(i) {
  ...
  V.on(document, "click.bs.carousel.data-api", "[data-slide], [data-slide-to]", at.dataApiClickHandler), V.on(window, "load.bs.carousel.data-api", function () {
    for (var t = et.find('[data-ride="carousel"]'), e = 0, n = t.length; e < n; e++) at.carouselInterface(t[e], L(t[e], "bs.carousel"));
  });
  var lt = w();
  if (lt) {
    var ct = lt.fn[nt];
  ...
  var gt = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
    vt = function () {
      for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1) if (gt && navigator.userAgent.indexOf(t[e]) >= 0) return 1;
      return 0;
    }();
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/bootstrap.bundle-5.0.0.alpha-min.js"], null)
//# sourceMappingURL=/bootstrap.bundle-5.0.0.alpha-min.9b060bd2.js.map